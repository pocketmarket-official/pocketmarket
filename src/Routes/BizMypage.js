        ...
        <>
            ...
            <div className="mypage">
                <div className="mypage__box">
                    <div className="mypage__list"><Link to="">Master 등록</Link></div>
                    ...
                    <div className="mypage__list"><Link to="">일자별조회</Link></div>
                    <div className="mypage__list"><Link to="">월별조회</Link></div>
                </div>
