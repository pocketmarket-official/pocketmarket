...
class Store(models.Model):
    ...
    dvYn = models.CharField(max_length=17, default='N', blank=True)
    useYn = models.CharField(max_length=17, default='Y', blank=True)
...
class Funset(models.Model):
    ...
    callFg = models.CharField(max_length=17, null=True)
    ordPrtTy = models.CharField(max_length=17, null=True)
    alrYn = models.CharField(max_length=17, default='N')
    alrTy = models.CharField(max_length=17, null=True)
    alrPntFg = models.CharField(max_length=17, null=True)
    ...
    kktAlrFailFg = models.CharField(max_length=17, null=True)
...
class Pos(models.Model):
    ...
    cntPayYn = models.CharField(max_length=17, null=True)
    kktAlrTmplCd = models.CharField(max_length=50, null=True)
    takeOutYn = models.CharField(max_length=17, default='Y')
    callNoYn = models.CharField(max_length=17, default='Y')
...
class StoreDic(models.Model):
    ...
    dicType = models.CharField(max_length=17, default='1') #1:구매이력 있음/2:리뷰이력 있음
    insDt = models.DateTimeField(default=timezone.now, null=True)
    insUs = models.CharField(max_length=30,  null=True)
    modDt = models.DateTimeField(default=timezone.now, null=True)
    modUs = models.CharField(max_length=30,  null=True)
...
class StoreLike(models.Model):
    store = models.ForeignKey('store', on_delete=models.CASCADE, default=1)
    user = models.ForeignKey('users.User', on_delete=models.CASCADE, default=1)
    likeYn = models.CharField(max_length=17, default='Y')
    insDt = models.DateTimeField(default=timezone.now, null=True, blank=True)
    insUs = models.CharField(max_length=30,  null=True, blank=True)
    modDt = models.DateTimeField(default=timezone.now, null=True, blank=True)
    modUs = models.CharField(max_length=30,  null=True, blank=True)
