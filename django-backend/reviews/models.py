...
class Review(models.Model):
    ...
    img1 = models.ImageField(upload_to='images/review', null=True)
    img2 = models.ImageField(upload_to='images/review', null=True)
    img3 = models.ImageField(upload_to='images/review', null=True)
    img4 = models.ImageField(upload_to='images/review', null=True)
    img5 = models.ImageField(upload_to='images/review', null=True)
