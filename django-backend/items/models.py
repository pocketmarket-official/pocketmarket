...
class Item(models.Model):
    ...
    setYn = models.CharField(max_length=17, default='N')
    itemFg = models.CharField(max_length=17, default='1')
    ...
    ordPrtYn = models.CharField(max_length=17, default='N')
    ordPrtText = models.CharField(max_length=100, null=True)
    kdsSendYn = models.CharField(max_length=17, default='N')
...
class AddCat(models.Model):
    addCatCd = models.CharField(max_length=17, default='00000')
