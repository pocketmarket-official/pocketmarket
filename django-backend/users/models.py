...
class User(AbstractUser):
    ...
    bizYn = models.CharField(max_length=5, default='N')
    tmpFlag = models.CharField(max_length=5, default='2') #1:일반유저/2:사전예약자/3:사전예약적용완료/4:오픈할인적용완료/5:둘다적용완료
    guestYn = models.CharField(max_length=5, default='N')
...
class MyPlace(models.Model):
    ...
    defaultYn = models.CharField(max_length=5, default='N')
...
class Business(models.Model):
    ...
    orderYn = models.CharField(max_length=5, default='Y')
