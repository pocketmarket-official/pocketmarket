...
class SaleHeader(models.Model):
    ...
    saleDay = models.CharField(max_length=5, default='')
    ...
    returnYn = models.CharField(max_length=5, default='N')
    ...
    sendYn = models.CharField(max_length=5, default='N')
    orderStatus = models.CharField(max_length=5, default=1)#0:장바구니/1:수락대기중/2:조리중/3:조리완료/4:픽업완료(User)/5:픽업완료(Store)/6:리뷰작성/7:리뷰취소/9:반품
    ...
    reviewYn = models.CharField(max_length=5, default='N')
...
class SaleDetail(models.Model):
    ...
    taxAmt = models.FloatField(default=0.0)
    offTaxAmt = models.FloatField(default=0.0)
    taxYn = models.CharField(max_length=5, default='Y')
    totDcAmt = models.FloatField(default=0.0)
    pointDcAmt = models.FloatField(default=0.0)
...
class CardLog(models.Model):
    ...
    apprFlag = models.CharField(max_length=5, default=1) #[1:정상승인/2:임의등록]
    receiptId = models.CharField(max_length=30, default='')
    cancelId = models.CharField(max_length=50, default='')
    instFlag = models.CharField(max_length=5, default='0') #[0:할부없음/1:할부]
    instMonth = models.CharField(max_length=5, default='00')
...
class SoldoutLog(models.Model):
    ...
    saleDt = models.CharField(max_length=8, default='')
    itemCd = models.CharField(max_length=20, default='')
    soldoutYn = models.CharField(max_length=5, default='Y')
    insDt = models.DateTimeField(default=timezone.now, null=True)
    insUs = models.CharField(max_length=30,  null=True)
    modDt = models.DateTimeField(default=timezone.now, null=True)
    modUs = models.CharField(max_length=30,  null=True)
...
class CornerStateLog(models.Model):
    ...
    stateFlag = models.CharField(max_length=5, default='1') #[1:원활/2:혼잡/3:주문불가]
    insDt = models.DateTimeField(default=timezone.now, null=True)
    insUs = models.CharField(max_length=30,  null=True)
    modDt = models.DateTimeField(default=timezone.now, null=True)
    modUs = models.CharField(max_length=30,  null=True)
