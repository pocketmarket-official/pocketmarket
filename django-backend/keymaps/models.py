...
class TouchGroup(models.Model):
    ...
    touchGroupCd = models.CharField(max_length=17, default='000')
    touchGroupName = models.CharField(max_length=100, default='')
    imgUrl = models.CharField(max_length=200, null=True)
    imgUseYn = models.CharField(max_length=17, default='N')
...
class Keymap(models.Model):
    ...
    soldoutYn = models.CharField(max_length=17, null=True)
    cprtGroupCd = models.CharField(max_length=17, null=True)
    dispYn = models.CharField(max_length=17, default='Y')
