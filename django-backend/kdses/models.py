...
class SetMaster(models.Model):
    ...
    monitorFlag = models.CharField(max_length=5, default=1) #1:기본4분할/2:기본6분할/3:8분할/4:10분할/5:긴4분할/6:긴6분할
    summaryYn = models.CharField(max_length=5, default='Y')
    fontSize = models.CharField(max_length=5, default=10)
    orderExpandYn = models.CharField(max_length=5, default='Y')
    soundYn = models.CharField(max_length=5, default='Y')
...
class KdsHeader(models.Model):
    ...
    orderStatus = models.CharField(max_length=5, blank=True)
