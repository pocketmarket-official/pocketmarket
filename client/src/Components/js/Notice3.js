...
function Notice3() {
    return (
        <>
            <div>
<h2><strong>위치기반서비스 이용약관</strong></h2>
<br />
<br />
<br />
<h3><strong>제1장 총   칙</strong></h3>
<br />
<br />
<strong>제 1 조 (목적)</strong> 본 약관은 회원(서비스 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다.)이 포켓마켓(이하 “회사”라고 합니다.)가 제공하는 위치기반 서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
<br />
<br />
<strong>제 2 조 (이용약관의 효력 및 변경)</strong>
<br />
  ①본 약관은 서비스를 신청한 고객 또는 개인위치정보주체가 본 약관에 동의하고 회사가 정한 소정의 절차에 따라 서비스의 회원으로 등록함으로써 효력이 발생합니다.
  <br />
...
<br />
<br />
<strong>제 3 조 (관계법령의 적용)</strong>  본 약관은 신의성실의 원칙에 따라 공정하게 적용하며, 본 약관에 명시되지 아니한 사항에 대하여는 관계법령 또는 상관례에 따릅니다.
<br />
<br />
<strong>제 4 조 (서비스의 내용)</strong>  회사는 직접 수집하거나 위치정보사업자로부터 수집한 회원의 현재 위치정보 및 상태 정보 또는 현재 위치가 포함된 지역을 이용하여 아래와 같은 위치기반서비스를 제공합니다.
<br />
<br />
<table>
    <th>서비스 명</th>
...
① 위치정보수집대상의 위치 확인
<br />
② 회원의 위치에서 근접한 업소정보 제공
<br />
③ 위치정보를 활용한 정보 검색 결과 및 콘텐츠를 제공하거나 추천
        </td>
    </tr>
</table>
<br />
...
<br />
  ...
  <br />
  <br />
<strong>제 6 조 (서비스내용변경 통지 등)</strong>
<br />
  ①회사가 서비스 내용을 변경하거나 종료하는 경우 회사는 회원의 등록된 전자우편 주소로 이메일을 통하여 서비스 내용의 변경 사항 또는 종료를 통지할 수 있습니다.
  <br />
  ②위 항의 경우 불특정 다수인을 상대로 통지를 함에 있어서는 웹사이트 등 기타 회사의 공지사항을 통하여 회원들에게 통지할 수 있습니다.
  <br />
  <br />
<strong>제 7 조 (서비스이용의 제한 및 중지)</strong>
<br />
...
<br />
<br />
<strong>제 8 조 (회원의 이용제한 등)</strong>
<br />
 ①회사는 회원이 아래 각 호에 해당하는 경우에는 회원의 동의 없이 서비스의 전부 또는 일부의 이용을 제한하거나 중지시킬 수 있습니다.
 <br />
&nbsp;&nbsp;&nbsp;&nbsp;1. 회원이 법률, 공공질서나 도덕 및 미풍양속에 위반하는 목적으로 서비스 이용을 계획하거나 실행하는 경우
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;2. 관계법령 및 이 약관의 규정을 위반하는 경우
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;3. 회원이 회사의 업무수행 또는 전산설비에 현저한 지장을 초래하거나, 초래할 위험성이 있는 경우
    <br />
<br />
<strong>제 9 조 (이용제한 및 해제 절차)</strong>
<br />
 ①회사는 제 8조의 규정에 의하여 이용제한을 하고자 하는 경우에는 그 사유, 일시 및 기간을 정하여 이용정지 7일전까지 전자우편 또는 전화 등의 방법에 의하여 해당 회원 또는 대리인에게 통지합니다. 다만, 긴급하게 이용을 정지할 필요가 있다고 인정하는 경우에는 그러하지 아니합니다.
 <br />
 ②제①항의 규정에 의하여 이용정지의 통지를 받은 회원 또는 그 대리인은 그 이용정지의 통지에 대하여 이의가 있을 때에는 이의신청을 할 수 있습니다.
 <br />
 ③회사는 제②항의 규정에 의한 이의신청에 대하여 그 확인을 위한 기간까지 이용정지를 일시 연기할 수 있으며, 그 결과를 회원 또는 그 대리인에게 통지합니다.
 <br />
 ④회사는 이용정지 기간 중에 이용정지 사유가 해소된 것이 확인된 경우에는 이용정지조치를 즉시 해제합니다.
 <br />
<br />
<strong>제 10 조 (개인위치정보의 이용 또는 제공)</strong>
<br />
  ①회사는 개인위치정보를 이용하여 서비스를 제공하고자 하는 경우에는 미리 이용약관에 명시한 후 개인위치정보주체의 동의를 얻어야 합니다.
  <br />
  ②회원 및 법정대리인의 권리와 그 행사방법은 제소 당시의 회원의 주소에 의하며, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 회원의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.
  <br />
  ③회사는 타사업자 또는 이용 고객과의 요금정산 및 민원처리를 위해 위치정보 이용·제공․사실 확인자료를 자동 기록·보존하며, 해당 자료는 6개월간 보관합니다.
  <br />
  ④회사는 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원에게 제공받는 자, 제공일시 및 제공목적을 즉시 통보합니다. 단, 아래 각 호에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신 단말장치 또는 전자우편주소로 통보합니다.
  <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;2. 회원이 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우
    <br />
<br />
<strong>제 11 조 (개인위치정보주체의 권리)</strong>
<br />
...
<br />
<br />
<strong>제 12 조 (법정대리인의 권리)</strong>
<br />
...
<br />
<br />
<strong>제 13 조 (8세 이하의 아동 등의 보호의무자의 권리)</strong>
<br />
...
<br />
<br />
<strong>제 14 조 (위치정보관리책임자의 지정)</strong>
<br />
...
<br />
<br />
<strong>제 18 조 (분쟁의 조정 및 기타)</strong>
<br />
...
<br />
<br />
<strong>제 19 조 (회사의 연락처)</strong> 회사의 상호 및 주소 등은 다음과 같습니다.
<br />
&nbsp;&nbsp;1. 상    호 : 포켓마켓
  <br />
&nbsp;&nbsp;2. 대 표 자 : 장문진
  <br />
&nbsp;&nbsp;3. 주    소 : 서울특별시 강남구 개로포 508, B1층 203호
  <br />
&nbsp;&nbsp;4. 대표전화 : 010-9410-9188
<br />
<br />
<h3><strong>부  칙</strong></h3>

제1조 (시행일) 이 약관은 2021년 1월 26일부터 시행한다.
<br />
제2조 위치정보관리책임자는 2019년 00월을 기준으로 다음과 같이 지정합니다.
<br />
&nbsp;&nbsp;1. 성  명 : 장문진
  <br />
&nbsp;&nbsp;2. 연락처 : 010-9410-9188
